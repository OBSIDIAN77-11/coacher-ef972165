...
function StepHeader({ title, sub }: { title: string; sub?: string }) {
  return (
    <div className="mb-5 text-center">
      <h1 style={{ fontSize: 26, fontWeight: 900, color: "#FFFFFF", letterSpacing: "-0.5px" }}>
        {title}
      </h1>
      {sub && (
        <p style={{ fontSize: 13, color: "#8B98B0", fontWeight: 600, marginTop: 6 }}>{sub}</p>
      )}
    </div>
  );
}
    ...
    <>
      <div className="flex flex-col items-center pt-4">
        ...
        <p
          ...
          style={{ fontSize: 13, color: "#8B98B0", fontWeight: 600, maxWidth: 280 }}
        >
      ...
      <div className="mt-7 flex flex-col gap-2.5">
        {steps.map((s, i) => (
          ...
          >
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "#FFFFFF" }}>{s}</span>
          </div>
        ))}
      </div>
    ...
    <>
      ...
      <button
        ...
        style={{
          aspectRatio: "1.6 / 1",
          borderRadius: 18,
          border: `2px dashed ${img ? "#2563EB" : "#2A3B5C"}`,
          background: img ? "transparent" : "#0F1525",
        }}
      >
        {img ? (
          <>
          ...
          <div className="flex h-full flex-col items-center justify-center gap-2">
            ...
            <span style={{ fontSize: 11, color: "#8B98B0", fontWeight: 600 }}>
    ...
    <>
      ...
      {phase === "scanning" && (
        <div className="mt-5 flex items-center justify-center gap-2">
          ...
          />
          <span style={{ fontSize: 12, fontWeight: 700, color: "#8B98B0" }}>
      ...
      {phase === "done" && (
        <div className="mt-5">
          <div className="mb-2 flex items-center justify-between">
            <span style={{ fontSize: 12, fontWeight: 700, color: "#FFFFFF" }}>Overeenkomst</span>
