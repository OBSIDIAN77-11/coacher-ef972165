...
function TrainingTab() {
  ...
  return (
    <>
      ...
      >
        <div style={{ fontSize: 11, color: "#6B7A99", fontWeight: 800, textTransform: "uppercase", letterSpacing: 0.8 }}>
          Vandaag
        </div>
        <div style={{ fontSize: 17, fontWeight: 900, color: "#1E3A8A", marginTop: 4 }}>
          Billen & Benen
        </div>
          ...
          {ex.map((e, i) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div style={{ fontSize: 11, color: "#6B7A99", fontWeight: 600 }}>{e.s}</div>
              </div>
            </button>
          ))}
        </div>
      ...
      <div className="mt-4">
        <div style={{ fontSize: 13, fontWeight: 800, color: "#1E3A8A", marginBottom: 10 }}>Week overzicht</div>
          ...
          {week.map((w) => (
            <div
              ...
              style={{
                padding: "12px 14px",
                borderRadius: 12,
                background: w.today ? "rgba(37,99,235,0.10)" : "#F4F7FB",
                border: w.today ? "1px solid rgba(37,99,235,0.30)" : "1px solid #E6ECF4",
              }}
            >
              <div className="flex items-center gap-3">
                <span style={{ fontSize: 12, fontWeight: 800, color: "#6B7A99", width: 24 }}>{w.d}</span>
                <span style={{ fontSize: 13, fontWeight: 700, color: "#1E3A8A" }}>{w.w}</span>
              </div>
      ...
      {showCompliment && (
        ...
        >
          ...
          <button
            ...
            style={{ background: "transparent", border: "none", color: "#6B7A99", padding: 2 }}
          >
            <X size={14} />
          </button>
        </div>
      ...
      >
        <div className="relative" style={{ width: 130, height: 130 }}>
          <svg width="130" height="130" viewBox="0 0 130 130">
            <circle cx="65" cy="65" r="56" fill="none" stroke="#E6ECF4" strokeWidth="10" />
            <circle
              cx="65"
              cy="65"
              r="56"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div style={{ fontSize: 22, fontWeight: 900, color: "#1E3A8A" }}>{kcalLeft}</div>
            <div style={{ fontSize: 10, color: "#6B7A99", fontWeight: 700 }}>kcal over</div>
          </div>
        </div>
        ...
        {meals.map((m, i) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span style={{ fontSize: 13, fontWeight: 800, color: "#1E3A8A" }}>{m.n}</span>
            </div>
            <span style={{ fontSize: 12, color: "#6B7A99", fontWeight: 700 }}>{m.k} kcal</span>
          </button>
        ))}
      </div>
    </>
  ...
  return (
    <div>
      <div className="flex items-center justify-between" style={{ marginBottom: 4 }}>
        <span style={{ fontSize: 11, fontWeight: 700, color: "#1E3A8A" }}>{label}</span>
        <span style={{ fontSize: 10, fontWeight: 700, color: "#6B7A99" }}>{g}/{target}g</span>
      </div>
      <div style={{ height: 6, borderRadius: 999, background: "#E6ECF4", overflow: "hidden" }}>
        ...
        {stage === "result" && (
          <>
            ...
            >
              ...
              <div style={{ fontSize: 12, color: "#6B7A99", fontWeight: 600, marginTop: 4 }}>
...
function VoortgangTab() {
  ...
  return (
    <>
      <div style={{ padding: 16, borderRadius: 16, background: "#F4F7FB", border: "1px solid #E6ECF4" }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: "#6B7A99", textTransform: "uppercase", letterSpacing: 0.8 }}>
          Gewicht
        </div>
          ...
          {weeks.map((w) => (
            <div
              ...
              style={{
                padding: "10px 12px",
                borderRadius: 10,
                background: w.now ? "linear-gradient(135deg,rgba(37,99,235,0.18),rgba(96,165,250,0.18))" : "#FFFFFF",
                border: w.now ? "1px solid rgba(37,99,235,0.30)" : "1px solid #E6ECF4",
              }}
            >
              <div className="flex items-center gap-2">
                <span style={{ fontSize: 12, fontWeight: 700, color: "#1E3A8A" }}>{w.l}</span>
                {w.now && (
              ...
              <span style={{ fontSize: 13, fontWeight: 800, color: "#1E3A8A" }}>{w.w}kg</span>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <label
      ...
      style={{
        height: 160,
        borderRadius: 14,
        background: value ? "transparent" : "#F4F7FB",
    ...
    >
      {value ? (
        ...
        <>
          <Upload size={22} color="#6B7A99" />
          <span style={{ fontSize: 11, color: "#6B7A99", fontWeight: 700, marginTop: 6 }}>{label}</span>
        </>
      )}
      <input
        type="file"
  ...
  if (sent) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: 18, fontWeight: 900, color: "#1E3A8A", marginTop: 16 }}>
          Check-in verstuurd!
        </div>
        <p style={{ fontSize: 12, color: "#6B7A99", fontWeight: 600, marginTop: 6 }}>
    ...
    <>
      ...
      <div className="mt-4 flex flex-col gap-4">
        ...
        <Question label="Hoe is je energie deze week?">
          <div className="flex items-center justify-between" style={{ fontSize: 11, color: "#6B7A99", fontWeight: 700, marginBottom: 6 }}>
            <span>Laag</span>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    fontSize: 11,
                    fontWeight: 800,
                    background: a ? "linear-gradient(135deg,#2563EB,#60A5FA)" : "#FFFFFF",
                    color: a ? "white" : "#6B7A99",
                    border: a ? "none" : "1px solid #E6ECF4",
                  }}
                >
                  {s}
                </button>
            ...
            {["Nee", "Bijna", "Ja"].map((s, i) => (
              <button
                ...
                style={{
                  ...
                  fontSize: 11,
                  fontWeight: 800,
                  background: i === 2 ? "linear-gradient(135deg,#2563EB,#60A5FA)" : "#FFFFFF",
                  color: i === 2 ? "white" : "#6B7A99",
                  border: i === 2 ? "none" : "1px solid #E6ECF4",
                }}
              >
                {s}
              </button>
...
function Question({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    ...
    >
      <div style={{ fontSize: 12, fontWeight: 800, color: "#1E3A8A", marginBottom: 10 }}>{label}</div>
      {children}
    </div>
  );
}
