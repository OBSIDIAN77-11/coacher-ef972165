  ...
  return (
    <div className="fade px-5 py-6">
      ...
      <Section title="Agenda vandaag" badge="4 sessies" badgeColor="#60A5FA">
        <div style={{ borderRadius: 18, background: "#000000", border: "1px solid #1E2A44", overflow: "hidden" }}>
          {SESSIONS.map((s, i) => (
            <div
              key={i}
              ...
              style={{
                padding: 12,
                borderTop: i === 0 ? "none" : "1px solid #1E2A44",
              }}
            >
              <div
              ...
              <div className="flex-1 min-w-0">
                <div style={{ fontSize: 14, fontWeight: 800, color: "#FFFFFF" }}>{s.name}</div>
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 20, fontWeight: 900, color: "#FFFFFF", letterSpacing: "-0.5px" }}>{value}</div>
      <div style={{ fontSize: 10, color: "#8B98B0", fontWeight: 700, marginTop: 2 }}>{title}</div>
